 ...
 */
@WebServlet(name = "AuthorTable", urlPatterns = {"/AuthorView"})
public class AuthorView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Author> list = logic.getAll();
            list.forEach(author
                    -> out.printf("<tr><td>%d</td><td>%s</td><td>%s</td></tr>",logic.extractDataAsList(author).toArray()));
